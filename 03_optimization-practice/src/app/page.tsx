...
export default function Home() {
  ...
  return (
    <main className="container mx-auto px-4 py-8" aria-label="메인">
      {/* ⚠️ SEO 최적화 안됨: section 태그 미사용, 일반 div만 사용 */}
      {/* Hero Section */}
      <section className="text-center mb-16" aria-labelledby="main-hero">
        ...
        <figure className="w-full max-w-4xl mx-auto h-64 md:h-96 rounded-lg overflow-hidden shadow-lg">
          <Image
      ...
      {/* 카테고리 섹션 */}
      <section className="mb-16" aria-labelledby="main-categories">
      ...
      {/* 인기 레시피 섹션 */}
      <section className="mb-16" aria-labelledby="main-popular">
      ...
      {/* 최신 레시피 섹션 */}
      <section className="mb-16" aria-labelledby="main-recent">
        <div className="flex items-center justify-between mb-8">
          <h2 className="font-display text-3xl font-bold text-gray-900 dark:text-gray-100">
            최신 레시피
          </h2>
